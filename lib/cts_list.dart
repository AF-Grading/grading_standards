...
class GradeItem {
  ...
  GradeItem(this.name, this.passingScore, this.performance, this.standards);
}

//Map<String, GradeItem> ctsList = {};
...
List<GradeItem> gradeItems = [
  ...
  GradeItem("Air Refueling", Grade.familiar, "Demonstrates sustained contacts.",
